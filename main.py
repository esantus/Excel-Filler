...
def main():
    ...
    parser.add_option('--mode', default='predict', action='store', type=str, help='save the mode (train, test, predict)')
    parser.add_option('-d', '--debug', default=False, action='store_true', help='if True, print debug information')
    #parser.add_option('-t', '--train', default=False, action='store_true', help='if True, train the output column models')
    #parser.add_option('-p', '--print', default=True, action='store_true', help='if train==False, it prints the excel file as output')
    parser.add_option('-c', '--cuda', default=False, action='store_true', help='if True, use the GPU')
    ...
    parser.add_option('--init_lr', default=0.001, action='store', type=float, help='save the initial learning rate')
    parser.add_option('--epochs', default=32, action='store', type=int, help='save the number of epochs')
